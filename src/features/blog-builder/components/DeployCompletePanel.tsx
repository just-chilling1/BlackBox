...
export function DeployCompletePanel({
  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-success/20 bg-pulse-100 p-5 sm:p-6">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <motion.button
          ...
          className="w-full rounded-xl border border-border-dim bg-white px-4 py-4 text-base font-medium text-text-primary shadow-sm transition-colors hover:border-[var(--np-line-pulse)] hover:bg-pulse-100 hover:text-pulse-700"
        >
