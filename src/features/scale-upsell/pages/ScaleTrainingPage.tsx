...
export default function ScaleTrainingPage() {
    return (
        <div className="page-container pb-10">
            ...
            >
                <div className="inline-flex items-center gap-2 bg-brass-100 border border-[var(--bb-line-brass)] rounded-full px-5 py-2">
                    <Sparkles size={14} className="text-brass-700" />
                    <span className="text-[13px] font-medium text-brass-700 uppercase tracking-[0.15em]">Exclusive Training</span>
                </div>

                <h1 className="brand-font text-4xl md:text-5xl lg:text-6xl font-medium text-text-heading leading-tight max-w-3xl">
                    Scale Your{" "}
                    <span className="text-brass-700">{brand.productName}</span>
                    {" "}To $1,000+ Per Day
                </h1>
            ...
            >
                <a
                    ...
                    className="group relative inline-flex items-center gap-3 bg-grad-brass hover:brightness-105 text-black font-medium text-lg px-10 py-5 rounded-xl transition-all shadow-brass hover:shadow-brass"
                >
