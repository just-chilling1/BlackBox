  ...
  return (
    ...
    >
      ...
      <section className="glass-card overflow-hidden p-0">
        <div className="border-b border-black/[0.06] bg-emerald-500/5 p-6 md:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <button
              ...
              onClick={runScan}
              disabled={scanning}
              className="inline-flex shrink-0 items-center justify-center gap-2 rounded-lg border border-black/[0.08] bg-black/[0.04] px-4 py-2.5 text-sm font-semibold text-text-primary hover:bg-black/[0.08] disabled:opacity-50"
            >
        ...
        <div className="grid grid-cols-2 gap-3 p-6 sm:grid-cols-4 md:p-8">
          {protectionLayers.map((layer) => {
            ...
            return (
              <div
                key={layer.label}
                className="rounded-xl border border-black/[0.06] bg-black/[0.02] p-3 text-center"
              >
      ...
      <div className="grid gap-6 lg:grid-cols-3">
              ...
              {securityChecks.map((check, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex flex-col gap-3 rounded-xl border border-black/[0.06] bg-black/[0.02] p-4"
                  >
        ...
        <div className="space-y-6">
          <section className="glass-card overflow-hidden p-0">
            <div className="border-b border-black/[0.06] bg-accent/5 p-5">
