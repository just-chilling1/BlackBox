  ...
  return (
    <section className="glass-card p-8">
      <div className="mb-8 flex items-center gap-3">
        <CheckCircle2 size={22} className="text-brass-700" />
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
        {steps.map((step) => (
          <div
            key={step.num}
            className="flex flex-col gap-4 rounded-2xl border border-[var(--bb-line-brass)] bg-brass-100 p-6"
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-grad-brass text-sm font-medium text-black">
              {step.num}
            </div>
