      ...
      <div className={mobile ? "space-y-1.5" : "space-y-0.5"}>
        {offers.map((offer) => (
          <a
            ...
            className={clsx(
              "exclusive-offers-nav-item flex items-center gap-2 rounded-md text-[13px] font-normal text-ink transition-[background-color,color] duration-[160ms] hover:text-brass-700",
          ...
          >
            ...
            <ExternalLink className="h-3 w-3 shrink-0 text-ink-4" strokeWidth={1.75} />
          </a>
        ))}
      </div>
    </div>
