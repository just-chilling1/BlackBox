...
const RESERVED_HANDLES = new Set([
  ...
  "autopilot", "brand-preview", "dashboard", "deploy", "dfy", "forgot-password",
  "instant", "link-vault", "login", "offers", "onboarding", "promote",
  "protector", "radar", "recurring-wealth", "replies", "reset-password",
